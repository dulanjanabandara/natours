...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHVsYW5qYW5hYiIsImEiOiJjbDFqM2M0dGwwdHk2M2puMnZ3NHJkY3VzIn0.-vd5HsdrDzPd3O7nRcYHgQ';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true); // true - reloads from the server. not from the browser cache.
            }
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // in order to recreate multipart form data
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13341" + '/');
